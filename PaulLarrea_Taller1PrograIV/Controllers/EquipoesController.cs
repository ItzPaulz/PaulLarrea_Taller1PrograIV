...
namespace PaulLarrea_Taller1PrograIV.Controllers
{
    public class EquipoesController : Controller
    {
        ...
        public EquipoesController(PaulLarrea_Taller1PrograIVContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Titulos,AceptaExtranjeros")] Equipo equipo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Nombre,Titulos,AceptaExtranjeros")] Equipo equipo)
        {
            if (id != equipo.Id)
            {
                return NotFound();
